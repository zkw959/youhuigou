  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <button style="width: 100px;height: 38px;vertical-align: top;" @click="getCode">点击获取验证码</button>
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="content">
        <label>登录密码:</label>
  ...
  export default {
    ...
    methods: {
      ...
      async register(){
        ...
        try {
         if(phone && agree && code && password === password1){
           let message = await this.$store.dispatch("register",{phone,password,code})
           alert(message)
           if(message === '成功'){
