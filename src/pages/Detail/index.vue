<template>
  <div>
    ...
    <section class="con">
      ...
      <div class="conPoin">
        <div class="conPoin">
          <a href="###" v-if="categoryView.category1Id">{{categoryView.category1Name}}</a>
          <a href="###" v-if="categoryView.category2Id">{{categoryView.category2Name}}</a>
          <a href="###" v-if="categoryView.category3Id">{{categoryView.category3Name}}</a>
        </div>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                v-on:click="changeActive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 跳转其他页面之前，先发送请求，告知服务器进行存储 -->
                <a @click="addShopcar" target="_blank">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
  ...
  methods: {
    ...
    changeskuNum(event){
      ...
      if(isNaN(value)){
        ...
        this.skuNum = newValue>0?newValue:1
      }
    ...
    async addShopcar(){
      ...
      try {
        await this.$store.dispatch("adOrUpdateShopCart",{
